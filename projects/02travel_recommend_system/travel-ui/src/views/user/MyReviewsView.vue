  ...
  <div class="my-reviews-container">
    <el-card class="box-card" shadow="never">
      ...
      <div v-if="isWriting" class="write-review-section">
        <el-form :model="reviewForm" :rules="rules" ref="reviewFormRef" label-width="120px" label-position="top">
          ...
          <el-form-item>
            <el-button type="primary" :loading="submitLoading" @click="submit" class="submit-btn" size="large">提交点评</el-button>
          </el-form-item>
        </el-form>
      </div>

      <!-- 我的点评列表区 -->
      <div v-else class="reviews-list-section" v-loading="listLoading">
...
.status-pending { background-color: #fff8e6; color: #f59e0b; }
.status-approved { background-color: #ecfdf5; color: #10b981; }
